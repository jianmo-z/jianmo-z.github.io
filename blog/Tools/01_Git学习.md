...
![01Git工作流程](./Picture/01_Git工作流程.png)
...
![文件状态](./Picture/02_文件状态.png)

### 差异比较

![03差异比较](./Picture/03_差异比较.png)
...
![04Git本地版本库](./Picture/04_Git本地版本库.png)
...
>
>    ![06rebase合并分支](./Picture/07_rebase合并分支.png)
>
